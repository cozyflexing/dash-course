...
data["Total Cost (Sales & Marketing)"] = data[
    "Total Cost (Sales & Marketing)"
].str.replace(",", "")
data["Target"] = data["Target"].str.replace(",", "")

# Change data type of columns
data["Revenues"] = data["Revenues"].astype("int64")
data["Total Cost (Sales & Marketing)"] = data["Total Cost (Sales & Marketing)"].astype(
    "int64"
)
    ...
    (
        ...
        html.Div(
            [
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                dcc.Graph(
                                    id="chart1", config={"displayModeBar": False}
                                ),
                            ],
                            className="chart",
                        ),
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                dcc.Graph(
                                    id="chart2", config={"displayModeBar": False}
                                ),
                            ],
                            className="chart",
                        ),
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                dcc.Graph(
                                    id="chart3", config={"displayModeBar": False}
                                ),
                            ],
                            className="chart",
                        ),
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                dcc.Graph(
                                    id="chart4", config={"displayModeBar": False}
                                ),
                            ],
                            className="chart",
                        ),
                ...
                html.Div(
                    [
                        html.Div(id="text5", className="card_size"),
                        html.Div(
                            [
                                dcc.Graph(
                                    id="chart5", config={"displayModeBar": False}
                                ),
                            ],
                            className="chart",
                        ),
                ...
                html.Div(
                    [
                        html.Div(id="text6", className="card_size"),
                        html.Div(
                            [
                                dcc.Graph(
                                    id="chart6", config={"displayModeBar": False}
                                ),
                            ],
                            className="chart",
                        ),
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.Div(
                                    id="donut_chart_text1", className="donut_chart_text"
                                ),
                            ],
                        ...
                        html.Div(
                            [
                                ...
                                html.Div(
                                    id="donut_chart_text2", className="donut_chart_text"
                                ),
                            ],
                            className="chart_container",
                        ),
                        html.Div(
                            [
                                ...
                                html.Div(
                                    id="donut_chart_text3", className="donut_chart_text"
                                ),
                            ],
                            className="chart_container",
                        ),
...
@app.callback(Output("text1", "children"), [Input("select_month", "value")])
def update_text(select_month):
    ...
    if revenues_difference > 0:
        return [
            html.P(
                "Revenues",
                style={"color": "white", "fontSize": 17, "font-weight": "bold"},
                className="card_title",
            ),
            html.Div(
                [
                    html.P(
                        "${0:,.0f}".format(revenues),
                        style={"color": "white", "fontSize": 25, "font-weight": "bold"},
                    ...
                    html.Div(
                        [
                            html.I(
                                ...
                                style={"font-size": "35px", "color": "#00cc00"},
                            ),
                        ],
            ...
            html.Div(
                [
                    html.Div(
                        [
                            html.P(
                                "+${0:,.2f}".format(revenues_difference),
                                style={
                                    "color": "#00cc00",
                                    "fontSize": 14,
                                },
                            ...
                            html.P(
                                "+{0:,.1f}%".format(revenues_pct_change),
                                style={
                                    "color": "#00cc00",
                                    "fontSize": 14,
                                },
                    ...
                    html.P(
                        "vs previous month",
                        style={"color": "white", "fontSize": 13, "font-weight": "bold"},
                    ...
                    html.Div(
                        [
                            html.I(
                                ...
                                style={"font-size": "35px", "color": "#EC1E3D"},
                            ),
                        ],
                        className="value_indicator",
                    ),
            ...
            html.Div(
                [
                    html.Div(
                        [
                            html.P(
                                "-${0:,.2f}".format(abs(revenues_difference)),
                                style={
                                    "color": "#EC1E3D",
                                    "fontSize": 14,
                                },
...
@app.callback(Output("chart1", "figure"), [Input("select_month", "value")])
...
@app.callback(Output("text2", "children"), [Input("select_month", "value")])
def update_text(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
            ...
            html.Div(
                [
                    html.Div(
                        [
                            html.P(
                                "-${0:,.2f}".format(abs(profit_difference)),
                                style={
                                    "color": "#EC1E3D",
                                    "fontSize": 14,
                                },
...
@app.callback(Output("chart2", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
...
@app.callback(Output("text3", "children"), [Input("select_month", "value")])
def update_text(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
            ...
            html.Div(
                [
                    html.Div(
                        [
                            html.P(
                                "-{0:,.2f}".format(abs(orders_difference)),
                                style={
                                    "color": "#EC1E3D",
                                    "fontSize": 14,
                                },
...
@app.callback(Output("chart3", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
...
@app.callback(Output("text4", "children"), [Input("select_month", "value")])
def update_text(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
            ...
            html.Div(
                [
                    html.Div(
                        [
                            html.P(
                                "+{0:,.2f}".format(Customers_difference),
                                style={
                                    "color": "#00cc00",
                                    "fontSize": 14,
                                },
                            ...
                            html.P(
                                "+{0:,.1f}%".format(Customers_pct_change),
                                style={
                                    "color": "#00cc00",
                                    "fontSize": 14,
                                },
            ...
            html.Div(
                [
                    html.Div(
                        [
                            html.P(
                                "-{0:,.2f}".format(abs(Customers_difference)),
                                style={
                                    "color": "#EC1E3D",
                                    "fontSize": 14,
                                },
...
@app.callback(Output("chart4", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
...
@app.callback(Output("text5", "children"), [Input("select_month", "value")])
def update_text(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
            ...
            html.Div(
                [
                    html.Div(
                        [
                            html.P(
                                "-{0:,.2f}".format(abs(items_difference)),
                                style={
                                    "color": "#EC1E3D",
                                    "fontSize": 14,
                                },
...
@app.callback(Output("chart5", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
...
@app.callback(Output("text6", "children"), [Input("select_month", "value")])
def update_text(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
            ...
            html.Div(
                [
                    html.Div(
                        [
                            html.P(
                                "+{0:,.2f}%".format(conversion_difference),
                                style={
                                    "color": "#00cc00",
                                    "fontSize": 14,
                                },
                            ...
                            html.P(
                                "+{0:,.1f}%".format(conversion_pct_change),
                                style={
                                    "color": "#00cc00",
                                    "fontSize": 14,
                                },
...
@app.callback(Output("chart6", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
...
@app.callback(Output("donut_chart1", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
    ...
    return {
        "data": [
            go.Pie(
                ...
                marker=dict(colors=colors, line=dict(color="#DEB340", width=2)),
                hoverinfo="skip",
                textinfo="text",
                hole=0.7,
                rotation=90,
...
@app.callback(Output("donut_chart_text1", "children"), [Input("select_month", "value")])
def update_text(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
    ...
    return [
        html.P(
            "{0:,.0f}%".format(percentage_profit),
            style={"color": "#DEB340", "fontSize": 25, "font-weight": "bold"},
        ),
    ]


@app.callback(Output("donut_chart2", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
...
@app.callback(Output("donut_chart_text2", "children"), [Input("select_month", "value")])
def update_text(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
    ...
    return [
        html.P(
            "{0:,.0f}%".format(percentage_target),
            style={"color": "#DEB340", "fontSize": 25, "font-weight": "bold"},
        ),
    ]


@app.callback(Output("donut_chart3", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
...
@app.callback(Output("donut_chart_text3", "children"), [Input("select_month", "value")])
def update_text(select_month):
    total_revenues = data["Revenues"].sum()
    total_target = data["Target"].sum()
    ytd_goal = (total_revenues / total_target) * 100
    ...
    return [
        html.P(
            "{0:,.0f}%".format(ytd_goal),
            style={"color": "#DEB340", "fontSize": 25, "font-weight": "bold"},
        ),
    ]


@app.callback(Output("funnel_chart", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
    ...
    return {
        "data": [
            go.Funnel(
                ...
                textposition="inside",
                textinfo="value",
                textfont=dict(family="Arial Black", size=14, color="#A23C33"),
                marker={"color": "#DEB340"},
                hoverinfo="skip",
            )
        ],
...
@app.callback(Output("bar_chart", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
...
@app.callback(Output("stack_bar_chart", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
    sales_target = data["Target"]
    above_the_target = data["Revenues"]
    data["Below the Target"] = np.where(
        data["Revenues"] < data["Target"], data["Revenues"], 0
    )
    months = data["Months"]
...
@app.callback(Output("percent_bar_chart", "figure"), [Input("select_month", "value")])
def update_graph(select_month):
    ...
    return {
        "data": [
            go.Bar(
                ...
                textfont=dict(family="sans-serif", size=14, color="white"),
...
@app.callback(Output("chart_text1", "children"), [Input("select_month", "value")])
def update_text(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
    ...
    return [
        html.Div(
            [
                html.P(
                    "AVG Sales / Customer",
                    style={"color": "white", "fontSize": 15, "font-weight": "bold"},
                    className="average_sales_text",
                ),
                html.P(
                    "${0:,.0f}".format(average_sales_per_customer),
                    style={"color": "white", "fontSize": 25, "font-weight": "bold"},
...
@app.callback(
    Output("average_sales_bar_chart1", "figure"), [Input("select_month", "value")]
)
def update_graph(select_month):
...
@app.callback(Output("chart_text2", "children"), [Input("select_month", "value")])
def update_text(select_month):
    if select_month is None:
        raise PreventUpdate
    else:
    ...
    return [
        html.Div(
            [
                ...
                html.P(
                    "${0:,.0f}".format(average_ticket_sales),
                    style={"color": "white", "fontSize": 25, "font-weight": "bold"},
                    className="average_sales_value",
                ),
            ],
...
@app.callback(
    Output("average_sales_bar_chart2", "figure"), [Input("select_month", "value")]
)
def update_graph(select_month):
